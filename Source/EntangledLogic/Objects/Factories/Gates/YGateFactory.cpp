...
void AYGateFactory::OnFactoryTick()
{
	Super::OnFactoryTick();
	if (IsQubitProcessed)
	{
...
void AYGateFactory::OnQubitProcessed()
{
...
void AYGateFactory::ConnectAllInputsAndOutputs()
{
...
void AYGateFactory::ConnectAllInputs()
{
...
void AYGateFactory::ConnectAllOutputs()
{

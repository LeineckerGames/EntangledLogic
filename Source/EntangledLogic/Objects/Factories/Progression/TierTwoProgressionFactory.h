...
#include "TierTwoProgressionFactory.generated.h"

UCLASS()
class ENTANGLEDLOGIC_API ATierTwoProgressionFactory : public AFactoryBase
{
	GENERATED_BODY()

	static constexpr int32 NUM_QUBIT_SLOTS = 8;
